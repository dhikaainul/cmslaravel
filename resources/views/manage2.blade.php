...
@section('konten')
     ...
     <tbody> 
         ...
         <tr> 
              ...
              <td>{{$a->content}}</td>
              <td>{{$a->created_at}}</td> 
              <td><a href="/cmslaravel/public/editkids/{{ $a->id }}" class="btn btn-primary btn-sm">Edit</a> 
                  <br></br>
                  <a href="/cmslaravel/public/deletekids/{{ $a->id }}" class="btn btn-primary btn-sm">Hapus</a> 
         </tr> 
         @endforeach 
     </tbody> 
</table> 
<a href="/cmslaravel/public/addmanagekids" class="btn btn-primary">Tambah Data</a>
